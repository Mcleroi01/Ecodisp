    ...
    <div class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            <div class="col-span-full lg:col-span-1">
                <a class="flex-none text-xl font-semibold dark:text-white focus:outline-none focus:opacity-80"
                    href="{{ route('public.client.home') }}" aria-label="Brand">
                    <span class="inline-flex items-center gap-x-2 text-xl font-semibold dark:text-white">
                        <img class="w-10 h-auto"
                            ...
                            alt="Ecole Doctoral">
                        <span class=" text-lg font-semibold text-white dark:text-white">Ecoles Doctorales
                            <p class=" text-lg font-semibold text-gray-500 dark:text-white">Isp/Gombe</p>
                        </span>
            ...
            <div class="col-span-1">
                <h4 class="font-semibold text-gray-100">Actualites</h4>

                <div class="mt-3 grid space-y-3">
                    <div class=" flex flex-col">
     
                        <div class="flex mb-3">
                            <div class="h-20 w-24 bg-cover"
                                style="background-image: url('https://ispgombe.ac.cd/images/_MG_2556.jpg')"
                                title="Woman holding a mug">
                            </div>
                            <div class="pl-3 w-9/12">
                                <div class="font-bold text-white text-sm">The Coldest Sunset</div>
                        ...
                        <div class="flex mb-3">
                            <div class="h-20 w-24 bg-cover"
                                style="background-image: url('https://ispgombe.ac.cd/images/IMG-20220502-WA0056.jpg')"
                                title="Woman holding a mug">
                            </div>
                            <div class="pl-3 w-9/12">
                                <div class="font-bold text-white text-sm">The Coldest Sunset</div>
            ...
            <div class="col-span-1">
                <h4 class="font-semibold text-gray-100">Liens</h4>
                ...
                <div class="mt-3 grid space-y-3">
                    <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                            href="{{ route('about.home') }}">Notre Ecole</a></p>
                    <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                            href="#">Admission</a></p>
                    <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                            href="#">Devenire Enseignat</a> <span
                            class="inline-block ms-1 text-sm bg-blue-700 text-white py-1 px-2 rounded-lg">Nous
                            embauchons</span></p>
                    <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                            href="#">Travaux</a></p>
                </div>
            ...
            <div class="col-span-2">
                <h4 class="font-semibold text-gray-100">Tiens-toi à jour</h4>
        ...
        <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div class="flex justify-between items-center">
                <p class="text-sm text-gray-400 dark:text-neutral-400"> All Rights Reserved © 2024 Copyright:
                    ECODISP/Gombe | Privacy | Security | Developer par Mcleroi01 avec </p>
            </div>
            <!-- End Col -->
