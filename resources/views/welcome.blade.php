    ...
    <section class="font-sans antialiased b bg-no-repeat  backdrop-blur-lg">
        <div class="px-4  backdrop-opacity-100 mx-auto max-w-screen-xl text-center py-24 lg:py-56 ">
            ...
            <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates eius possimus illum voluptas
                deserunt quisquam minus soluta tenetur in repellat provident pariatur modi doloribus quos dolor, quis
